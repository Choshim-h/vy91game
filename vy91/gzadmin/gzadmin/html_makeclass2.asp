...
top2=replace(top2,"<a href='/"&makeUrl_class&"/"&Replace(name," ","_")&"_1.html'>","<a class='menu3' href='/"&makeUrl_class&"/"&Replace(name," ","_")&"_1.html'>")
'-------------------top2结束
...
Do While not Rs.Eof
i=i+1
'<span><a href='/"&makeUrl_class&"/"&Replace(classname," ","_")&"_1.html'>"&rs("classname")&"</a></span>
top15=top15&"<li>"&i&"、<a href='/"&makeUrl_flash&"/"&Replace(rs("flashname")," ","_")&".html' target='_blank&play'>"&rs("flashname")&"</a></li>"
...
Rs.open("select id,flashname,nclass,classid,classname,pic from flash where classid='"&requestClassID&"' order by id Desc"),Conn,1,1
