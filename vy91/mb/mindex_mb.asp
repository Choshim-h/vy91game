...
%>
macool<%=rs("id")%>.style.display='block';
<%else%>
macool<%=rs("id")%>.style.display='none';
		<%		
		    end if				
		    rs.movenext
			loop
...
<div class="navclass-center">
<div class="navclass">
<ul>
<li class="on" style="background-image: url(images/acoolico.png);background-repeat: no-repeat;background-position: center 5px;"><a onclick="setPager('all');">ALL</a></li>
<li style="background-image: url(images/html5ico.png);background-repeat: no-repeat;background-position: center 5px;"><a onclick="setPager('html5');">HTML5</a></li>
<li style="background-image: url(images/Appleico.png);background-repeat: no-repeat;	background-position: center 5px;"><a onclick="setPager('ios');">iPHONE</a></li>
<li style="background-image: url(images/androidico.png);background-repeat: no-repeat;background-position: center 5px;"><a onclick="setPager('android');">ANDROID</a></li>
</ul>
</div>
</div>
...
<%
	  ...
	  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4" id="macool<%=rs("id")%>">
				<div class="holder">
					<div class="top-box">
...
<%
	...
	<div class="copyright col-xs-12 col-sm-6 col-md-6">
		© 2014 Acool.com | <a href="mailto:acoolgames@gmail.com"" class="contactUs" title="contact us" >Contact Us</a> 
	</div>
