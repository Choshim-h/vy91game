...
'------------------top15小游戏
Sql="select top 10 id,flashname,spic,classid,classname from flash where classid='"&classid&"' order by hits desc"
Rs.open Sql,Conn,1,3
i=0
Do While not Rs.Eof
i=i+1
top15=top15&"<div id='site_s3'><a href='/"&makeUrl_flash&"/"&Replace(rs("flashname")," ","_")&".html' title='"&rs("flashname")&"'><img src='/flashspic/"&rs("spic")&"'/></a><p class='site_s3_p1'><a href='/"&makeUrl_flash&"/"&Replace(rs("flashname")," ","_")&".html'>"&left(rs("flashname"),22)&"</a></p><p class='site_s3_p2'>["&rs("classname")&"]</p></div>"
