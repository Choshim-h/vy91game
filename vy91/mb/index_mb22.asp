	  ...
	  %>
                    ...
                    <div class="zjgxnew">
                      <table width="100" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="96" height="44" align="center"><a href="/<%=makeUrl_flash%>/<%=Replace(rs("flashname")," ","_")%>.html" target="_blank"><img src="flashspic/<%=rs("spic")%>" width="100" height="75" border="0" /></a></td>
                        </tr>
                        <tr>
                          <td height="55" align="center" valign="top"><a href="/<%=makeUrl_flash%>/<%=Replace(rs("flashname")," ","_")%>.html" target="_blank"><%=left(rs("flashname"),16)%></a></td>
                        </tr>
                      </table>
                    </div>
                  <%
    ...
    <td valign="top" bgcolor="#2A84E4"><table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
	  ...
	  %>
                    ...
                    <div class="zjgxnew1">
                      <table width="100" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td height="55" align="center" valign="top"><a href="/<%=makeUrl_flash%>/<%=Replace(rs("flashname")," ","_")%>.html" target="_blank"><%=left(rs("flashname"),20)%></a></td>
                        </tr>
                      </table>
                    </div>
                  <%
	  ...
	  %>
	   <%
		...
		if j>=4 then
	  %>
    <div class="zjgxnew2"><font color="#F66500">�� </font><a href="/<%=makeUrl_flash%>/<%=Replace(rs("flashname")," ","_")%>.html" target="_blank"><%=left(rs("flashname"),18)%></a>	</div>
    <%
		 end if
			j=j+1
			if i>maxList then exit do
