...
Response.Write "<form name=""myform"" Method=""Post"" action=""Html_MakemIndex.asp"">"
Response.Write "<tr>"
...
Response.Write ",模版文件:</font><a target=""_blank"" href=""../mIndex_mb.asp""><font color=""#FFFFFF"">../mIndex_mb.asp</font></a></b></td>"
Response.Write "</tr>"
Response.Write "<tr>"
Response.Write "<td width=""100%"" bgcolor=""#FFFFFF"" height=""100%"">"
Response.Write "<Textarea Style=""width:100%; height:100%;"" Rows=""19"" Name=""body"" Cols=""102"">" %><!--#include file="../mb/mindex_mb.asp"-->
<%
