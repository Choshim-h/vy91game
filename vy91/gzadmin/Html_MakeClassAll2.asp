...
Sql="Select id From Class where classid>'0' order by id asc"
...
n=0
do while not Rs.Eof
	exeFile="Html_MakeClass2.asp?classid="&rs("ID")&"&page="&pageSmall&"&pageBig="&CurrentPage&"&make=big"
