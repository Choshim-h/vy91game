...
<div class="wrapper">
        ...
        <div class="header" id="sticky_top">
            ...
            <div class="allnav">
                <div class="newnav">
                    <ul>
                        <li class="active"><a href="/new-games.html" target="_bock"><img src="./img/header-newgames.png" alt="">New</a></li>
                        <li><a href="/beauty-games.html" target="_bock"><img src="./img/header-bestgames.png" alt="">Best</a></li>
	  ...
	  %>
                    <li>
                        <a href="/<%=makeUrl_flash%>/<%=Replace(rs("flashname")," ","-")%>.html" class="game" target="_bock"
                            title="
                            <%=rs("flashname")%>">
                            <img src="<%=rs("mpic")%>" alt="
                            <%=rs("flashname")%>">
