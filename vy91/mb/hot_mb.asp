            ...
            <div class="allnav">
                <div class="newnav">
                    <ul>
                        ...
                        <li class="active"><a href="/hot-games.html" target="_bock"><img src="./img/header-hotgames.png" alt="">Hot</a></li>
            ...
            <div class="games container">
                <ul class="grid effect-2" id="grid">
                    <%
                        ...
                        sql="select * from flash where mpic<>'' and tag like '%html5%' order by geshou desc,hits desc"	
