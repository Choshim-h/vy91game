...
<table height="14" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
	  <td width="100" align="center" ><a id="smallMenu1" href="/user/myScore.asp">积分首页</a></td>
	  <%if session("username")<>"" then%>
	  <td width="100" align="center" ><a id="smallMenu2" href="/user/scoreRecord.asp">积分记录</a></td>
	   <td width="100" align="center" ><a id="smallMenu3" href="/user/scoreTo.asp">积分兑换</a></td>
	   <%end if%>
    </tr>
  </table>
</div>
