...
If Request("pageSmall")<>"" Then
	pageSmall=Cint(Request("pageSmall"))
	else
	pageSmall=1
End If
...
Response.Write "</Head>"
Response.Write "<body>"
Response.Write "·<b><font color=""#FF0000"" size=""3"">生成所有标签的Html页面,请等待...........</font></b><br/>"

Set Rs=Server.Createobject("Adodb.Recordset")
Sql="Select id From Tag where id>'0' order by id asc"
...
do while not Rs.Eof and n<rs.pagesize
	exeFile="Html_MakeTag.asp?classid="&rs("ID")&"&page="&pageSmall&"&pageBig="&CurrentPage&"&make=big"
