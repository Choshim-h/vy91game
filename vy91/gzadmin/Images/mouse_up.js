...
var o=event.srcElement;
	...
	if(o.alt!=null && o.alt!=""){o.dypop=o.alt;o.alt=""};
        ...
        {
          var temptitle=o.title;
          var realtitle="";
          var place;
         // place=temptitle.indexOf('推荐指数');
         // place=temptitle.indexOf('<br>',place);
          realtitle=temptitle.substring(0,place+4);
          temptitle=temptitle.substring(place+4);
          while (temptitle.length>20)
          {
            realtitle=realtitle+temptitle.substring(0, 20);
            temptitle=temptitle.substring(20,temptitle.length);

          }
            realtitle=realtitle+temptitle;
            o.dypop=realtitle;o.title="";
